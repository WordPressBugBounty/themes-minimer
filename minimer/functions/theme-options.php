...
Kirki::add_section( 'reviewlink', array(
	...
	'button_url'  => 'https://wordpress.org/support/theme/minimer/reviews/#new-post',
	'priority'    => 1,
) );
...
Kirki::add_field( 'minimer_theme', array(
	...
	'section'		=> 'social',
	'tooltip'		=> esc_html__( 'Font Awesome names:', 'minimer' ) . ' <a href="https://fontawesome.com/search?o=r&m=free&f=brands" target="_blank"><strong>' . esc_html__( 'View All', 'minimer' ) . ' </strong></a>',
	'row_label'		=> array(
		'type'	=> 'text',
	...
	'fields'		=> array(
		...
		'social-icon'	=> array(
			...
			'description'	=> esc_html__( 'Font Awesome icons. Ex: fa-facebook ', 'minimer' ) . ' <a href="https://fontawesome.com/search?o=r&m=free&f=brands" target="_blank"><strong>' . esc_html__( 'View All', 'minimer' ) . ' </strong></a>',
			'default'		=> 'fa-',
		),
		'social-link'	=> array(
			'type'			=> 'link',
