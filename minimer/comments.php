...
<div id="comments" class="themeform">
	...
	<?php if ( have_comments() ) : global $wp_query; ?>
		...
		<h3 class="heading"><?php comments_number( esc_html__( 'No Responses', 'minimer' ), esc_html__( '1 Response', 'minimer' ), esc_html__( '% Responses', 'minimer' ) ); ?></h3>
	
		<ul class="comment-tabs group">
			<li class="active"><a href="#commentlist-container"><i class="fas fa-comments"></i><?php esc_html_e( 'Comments', 'minimer' ); ?><span><?php echo count($wp_query->comments_by_type['comment']); ?></span></a></li>
